...
class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create
    ...
    if resource.persisted?
      create_default_profile_image(resource.id)
  ...
  def create_default_profile_image(user_id)
    Dir.mkdir("public/uploads/user/image/#{user_id}")
    FileUtils.cp("public/uploads/user/image/default_icon.jpeg", "public/uploads/user//image/#{user_id}/default_icon.jpeg")
  end
end
